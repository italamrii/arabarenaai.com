export const en = {
  ...
  admin: {
    ...
    cost: {
      ...
      estimated: "Estimated",
      estimatedNote: "Costs are estimates and may differ from actual provider billing.",
      costToday: "Cost today",
      costMonth: "Cost this month",
      inputTokensToday: "Input tokens today",
      outputTokensToday: "Output tokens today",
      avgCostPerComparison: "Avg cost per comparison",
      mostExpensiveProviderToday: "Most expensive provider today",
      mostExpensiveModelToday: "Most expensive model today",
      costByProvider: "Cost by provider",
      costByModel: "Cost by model",
      modelColumn: "Model",
      missingPricingModels: "Models without pricing",
    },
    usage: {
