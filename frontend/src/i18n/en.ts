export const en = {
  ...
  admin: {
    ...
    modelRegistry: {
      sectionTitle: "Model Registry Manager",
      tableTitle: "Registered models",
      hint: "Manage model metadata in the database. API keys stay in environment variables only.",
      addModel: "Add model",
      editModel: "Edit model",
      searchPlaceholder: "Search models…",
      allProviders: "All providers",
      loadFailed: "Could not load model registry",
      saveFailed: "Could not save model",
      createdSuccess: "Model created",
      updatedSuccess: "Model updated",
      archivedSuccess: "Model archived",
      archiveConfirm: "Archive this model? It will be disabled and hidden from public lists.",
      test: "Test model",
      ...
      archived: "Archived",
      attachmentsYes: "Attachments supported",
      attachmentsNo: "No attachments",
      adapterMissing: "Adapter/key not configured",
      fields: {
        key: "Model key",
        provider: "Provider",
        nameAr: "Arabic name",
